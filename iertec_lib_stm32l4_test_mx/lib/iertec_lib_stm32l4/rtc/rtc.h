 ...
 * @param centiseconds Centiseconds of the current timestamp.
 */
 ...
 *
 * @param datetime Pointer to date/time to set.
 ...
 *
 * @param datetime Pointer where to store the current date/time.
 */
 ...
 *
 * @param datetime_1 First date to compare.
 * @param datetime_2 Second date to compare.
 *
